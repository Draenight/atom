...
class CharacterRepository
{
  ...
  {
    $response = $this->base->prepare('INSERT INTO characters (name, password, hp, ap, lastaction) VALUES(:name, :password, :hp, :ap, :lastaction)');
    ...
    $response->bindValue(':lastaction', $character->getLastAction());
